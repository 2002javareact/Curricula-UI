...
interface ICreateCatProps
{
    CreateCat: Category
    errorMessage:string
    submitCatActionMapper:(ci:number, cc: string, cn: string )=>void
}
...
{
    e.preventDefault()
    this.props.submitCatActionMapper(this.state.categoryId, this.state.categoryColor,this.state.categoryName)
    this.setState({    
